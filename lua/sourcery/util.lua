local hsluv = require("sourcery.hsluv")
...
function util.debug(colors)
  colors = colors or require("sourcery.colors")
  -- Dump unused colors
...
function util.onColorScheme()
  if vim.g.colors_name ~= "sourcery" then
    vim.cmd([[autocmd! Sourcery]])
